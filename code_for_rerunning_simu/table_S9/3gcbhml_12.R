...
for(t in 1:nstage){
  ...
  Ye<-Ye0[1:ngroup_all[t,1],,]*tp_expand
  Yt<-Yt0[1:ngroup_all[t,1],,]*tp_expand
  ...
  for(i in 1:nsimu){
    ...
    ##mcmc-rjags
    # jagsmodel <- jags.model(file="BHMmodel_try.txt", data=data, inits=jags_inits, 
    #                     n.chains=1, n.adapt = 3000)
...
##save
save(Pr_futility,pr_eff,n,pE_hat_tmp,pT_hat_tmp,file="Rdata/3interim_12.Rdata")
