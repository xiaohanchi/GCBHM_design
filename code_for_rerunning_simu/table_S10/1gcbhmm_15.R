...
for(t in 1:nstage){
  ...
  y<-y+sapply(1:nsimu,function(r) sapply(1:Ngroup,function(r) rmultinom(rep(1,Ngroup),ninterim[t],p[,r])))*tp_expand
...
##save
save(Pr_futility,pr_eff,n,p_hat,file="Rdata/1gcbhmm_15.Rdata")
