...
#   [1] doParallel_1.0.17 iterators_1.0.14  foreach_1.5.2     runjags_2.2.0-3   R2jags_0.7-1      rjags_4-14        coda_0.19-4      
# 
# loaded via a namespace (and not attached):
#   [1] compiler_4.1.2    tools_4.1.2       abind_1.4-5       rstudioapi_0.15.0 codetools_0.2-18  grid_4.1.2        boot_1.3-28.1    
# [8] lattice_0.20-45   R2WinBUGS_2.1-21 
...
p<-p[,,15] #set different scenarios by changing the index here
q1<-c(0.25,0.5)
q0<-c(0.15,0.3)
p_mid<-(q1+q0)/2
...
sigma_gcbhml_ep2<-round(sigma2_hat,digits = 2)
