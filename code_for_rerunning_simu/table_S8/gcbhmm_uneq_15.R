...
for(t in 1:nstage){
  ...
  y<-y+sapply(1:nsimu,function(l) sapply(1:Ngroup,function(r) rmultinom(rep(1,Ngroup),ninterim[t,r],p[,r])))*tp_expand
...
##save
save(Pr_futility,pr_eff,n,p_hat,file="Rdata/uneq_gcbhmm_15.Rdata")
