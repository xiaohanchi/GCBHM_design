...
p11<-ggplot(dplyr::filter(p_ep1_1,Group==1), aes(x=factor(Design),y=100*(p_est-0.45))) + 
...
p21<-ggplot(dplyr::filter(p_ep2_1,Group==1), aes(x=factor(Design),y=100*(p_est-0.3))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep1_2<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 1),
               ...
               dplyr::filter(p_convert_cbhmetox,Endpoint == 1),
               dplyr::filter(p_convert_cbhml,Endpoint == 1))
p12<-ggplot(dplyr::filter(p_ep1_2,Group==1), aes(x=factor(Design),y=100*(p_est-0.5))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep2_2<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 2),
               dplyr::filter(p_convert_cbhmetox,Endpoint == 2),
               dplyr::filter(p_convert_cbhml,Endpoint == 2))
p22<-ggplot(dplyr::filter(p_ep2_2,Group==1), aes(x=factor(Design),y=100*(p_est-0.2))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep1_3<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 1),
               ...
               dplyr::filter(p_convert_cbhmetox,Endpoint == 1),
               dplyr::filter(p_convert_cbhml,Endpoint == 1))
p13<-ggplot(dplyr::filter(p_ep1_3,Group==1), aes(x=factor(Design),y=100*(p_est-0.6))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep2_3<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 2),
               dplyr::filter(p_convert_cbhmetox,Endpoint == 2),
               dplyr::filter(p_convert_cbhml,Endpoint == 2))
p23<-ggplot(dplyr::filter(p_ep2_3,Group==1), aes(x=factor(Design),y=100*(p_est-0.2))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep1_4<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 1),
               ...
               dplyr::filter(p_convert_cbhmetox,Endpoint == 1),
               dplyr::filter(p_convert_cbhml,Endpoint == 1))
p14<-ggplot(dplyr::filter(p_ep1_4,Group==1), aes(x=factor(Design),y=100*(p_est-0.5))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep2_4<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 2),
               dplyr::filter(p_convert_cbhmetox,Endpoint == 2),
               dplyr::filter(p_convert_cbhml,Endpoint == 2))
p24<-ggplot(dplyr::filter(p_ep2_4,Group==1), aes(x=factor(Design),y=100*(p_est-0.12))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep1_5<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 1),
               ...
               dplyr::filter(p_convert_cbhmetox,Endpoint == 1),
               dplyr::filter(p_convert_cbhml,Endpoint == 1))
p15<-ggplot(dplyr::filter(p_ep1_5,Group==1), aes(x=factor(Design),y=100*(p_est-0.5))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep2_5<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 2),
               dplyr::filter(p_convert_cbhmetox,Endpoint == 2),
               dplyr::filter(p_convert_cbhml,Endpoint == 2))
p25<-ggplot(dplyr::filter(p_ep2_5,Group==1), aes(x=factor(Design),y=100*(p_est-0.25))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep1_6<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 1),
               ...
               dplyr::filter(p_convert_cbhmetox,Endpoint == 1),
               dplyr::filter(p_convert_cbhml,Endpoint == 1))
p16<-ggplot(dplyr::filter(p_ep1_6,Group==1), aes(x=factor(Design),y=100*(p_est-0.45))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep2_6<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 2),
               dplyr::filter(p_convert_cbhmetox,Endpoint == 2),
               dplyr::filter(p_convert_cbhml,Endpoint == 2))
p26<-ggplot(dplyr::filter(p_ep2_6,Group==1), aes(x=factor(Design),y=100*(p_est-0.3))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep1_7<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 1),
               ...
               dplyr::filter(p_convert_cbhmetox,Endpoint == 1),
               dplyr::filter(p_convert_cbhml,Endpoint == 1))
p17<-ggplot(dplyr::filter(p_ep1_7,Group==1), aes(x=factor(Design),y=100*(p_est-0.45))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep2_7<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 2),
               dplyr::filter(p_convert_cbhmetox,Endpoint == 2),
               dplyr::filter(p_convert_cbhml,Endpoint == 2))
p27<-ggplot(dplyr::filter(p_ep2_7,Group==1), aes(x=factor(Design),y=100*(p_est-0.3))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep1_8<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 1),
               ...
               dplyr::filter(p_convert_cbhmetox,Endpoint == 1),
               dplyr::filter(p_convert_cbhml,Endpoint == 1))
p18<-ggplot(dplyr::filter(p_ep1_8,Group==1), aes(x=factor(Design),y=100*(p_est-0.45))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep2_8<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 2),
               dplyr::filter(p_convert_cbhmetox,Endpoint == 2),
               dplyr::filter(p_convert_cbhml,Endpoint == 2))
p28<-ggplot(dplyr::filter(p_ep2_8,Group==1), aes(x=factor(Design),y=100*(p_est-0.3))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep1_9<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 1),
               ...
               dplyr::filter(p_convert_cbhmetox,Endpoint == 1),
               dplyr::filter(p_convert_cbhml,Endpoint == 1))
p19<-ggplot(dplyr::filter(p_ep1_9,Group==1), aes(x=factor(Design),y=100*(p_est-0.45))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
p_ep2_9<-rbind(dplyr::filter(p_convert_bhm,Endpoint == 2),
               dplyr::filter(p_convert_cbhmetox,Endpoint == 2),
               dplyr::filter(p_convert_cbhml,Endpoint == 2))
p29<-ggplot(dplyr::filter(p_ep2_9,Group==1), aes(x=factor(Design),y=100*(p_est-0.3))) + 
  geom_hline(yintercept = 0, linetype = 2, colour = "red")+
  geom_boxplot(fill = '#A4A4A4', color = "black")+
  scale_x_discrete(
    name='Design',
...
ggsave(p_final1, file='Results/Figure1.pdf', width=10, height=10,dpi = 800)
...
ggsave(p_final2, file='Results/Figure2.pdf', width=10, height=10,dpi = 800)
